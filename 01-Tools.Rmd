# Workflow tools: RMarkdown, Git, Github
...
<small>Figure 1. The bridge was reconstructed in 2017. Photography courtesy of Otak. </small>


![](https://waterdata.usgs.gov/nwisweb/local/state/co/text/pics/06752260big.jpg)


<small>Figure 2. Poudre River at Lincoln Bridge, Fort Collins, CO. Photograph courtesy of USGS.</small>


### Data Acquistion 


We retrieved discharge data from the USGS NWIS web service for the Poudre River at the Lincoln bridge using the readNWISdv() package. 
...
dygraph(discharge_xts) %>%
  dyOptions(strokeWidth = 0.7, drawPoints = TRUE, pointSize = 1.25, fillGraph=TRUE,fillAlpha=0.25,drawGrid = FALSE) %>%
  dyAxis("y",label = "") %>%
...
## Additional Cache la Poudre River Information
