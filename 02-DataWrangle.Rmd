...
```{r plot ndvi vs ndmi, echo=FALSE, warning=F,message=F}
...
```{r plot ndvi vs ndmi, facet wrap site, echo=FALSE, warning=F,message=F}
#Capitlize facet wrap labels 
...
#### NDVI-NDSI: Pre- and post-fire figure and analyses
