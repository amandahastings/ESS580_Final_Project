...
<small> Figure 1. Map visualizing (log transformed) average chlorophyll a concentrations across lakes. Includes lakes where the number of chlorophyll a observations exceed 200 within the LAGOS Limno dataset. </small>
