...
<small> **Figure 3. Map visualizing (log transformed) average chlorophyll a concentrations across lakes. Only includes lakes where chlorophyll a observations exceed 200 within the LAGOS Limno dataset (n > 200).** </small>
