...
In this project, we explored regression models for analyzing temperature and crop yield in Iowa, USA. We utilized PRISM temperature data and USDA National Agricultural Statistics Service (NASS) yield data for corn and soybeans.  
...
```{r tmax data, message=F, echo=FALSE}
...
### Question __: Is there a relationship between temperature and yield across all counties in 2018?
